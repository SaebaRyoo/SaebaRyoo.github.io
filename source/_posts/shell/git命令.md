...
## Update
> 此项为博主了解的时间为基础，并非git实际更新时间
### 2022.10.01更新

**github在更新后，无法通过用户名密码在终端登录提交代码，需要使用personal token**
**获取途径如下: github -> 个人头像 -> settings -> developer settings(拉到底) -> Personal access tokens**
**在设置token时，如果看不懂权限选项，那就都选上，过期时间设置长一点。然后在push代码的时候，不是填写github的登录密码了，而是使用这个生成的personal token**
